...
# with command line options: NANO -s NANO --mc --conditions 106X_mc2017_realistic_v9 --era Run2_2017,run2_nanoAOD_106Xv2 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 -n -1 --python_filename miniToNanoAOD_2017MC.py --fileout=file:nanoaod.root --no_exec

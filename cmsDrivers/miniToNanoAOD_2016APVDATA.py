...
# with command line options: NANO -s NANO --data --conditions 106X_dataRun2_v35 --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 -n -1 --python_filename miniToNanoAOD_2016APVDATA.py --fileout=file:nanoaod.root --no_exec

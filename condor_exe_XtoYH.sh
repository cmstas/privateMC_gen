...
then
    ...
    cmssw_cfg="miniToNanoAOD_2016MC.py"

elif [[ $ARGS == *"2016APV_MC"* ]]
then

    cmssw_cfg="miniToNanoAOD_2016APVMC.py"

elif [[  $ARGS == *"2017_MC"*  ]]
then 

    cmssw_cfg="miniToNanoAOD_2017MC.py"

elif [[  $ARGS == *"2018_MC"*  ]]
then 

    cmssw_cfg="miniToNanoAOD_2018MC.py"

elif [[  $ARGS == *"2016_Data"*  ]]
then 
    cmssw_cfg="miniToNanoAOD_2016DATA.py"

elif [[  $ARGS == *"2016APV_Data"*  ]]
then 

    cmssw_cfg="miniToNanoAOD_2016APVDATA.py"

elif [[  $ARGS == *"2017_Data"*  ]]
then 

    cmssw_cfg="miniToNanoAOD_2017DATA.py"

elif [[  $ARGS == *"2018_Data"*  ]]
then 

    cmssw_cfg="miniToNanoAOD_2018DATA.py"
